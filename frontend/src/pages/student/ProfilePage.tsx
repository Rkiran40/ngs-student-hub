...
export default function ProfilePage() {
  ...
  const onProfileSubmit = async (data: ProfileFormData) => {
    ...
    try {
      ...
      if (selectedFile) {
        // Upload profile image with description tag
        const uploadRes = await studentApi.uploadFile(selectedFile, 'Profile Picture');
        ...
        avatarUrl = uploadRes.upload?.file_url || uploadRes.file_url;
      }
            ...
            <TabsContent value="course">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Your course and program details</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <FormField
                    control={profileForm.control}
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="e.g., Bachelor of Technology, MBA, etc." disabled />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <select {...field} className="w-full border rounded px-3 py-2 bg-background disabled:opacity-50 disabled:cursor-not-allowed" disabled>
